...
## [\#](#_29-数组相关){.header-anchor} 29 数组相关 {#_29-数组相关}

### [\#](#_1-实现foreach方法){.header-anchor} 1 实现forEach方法 {#_1-实现foreach方法}
...
### [\#](#_2-实现filter方法){.header-anchor} 2 实现filter方法 {#_2-实现filter方法}
...
### [\#](#_3-实现find方法){.header-anchor} 3 实现find方法 {#_3-实现find方法}
...
### [\#](#_4-实现findindex方法){.header-anchor} 4 实现findIndex方法 {#_4-实现findindex方法}
...
### [\#](#_5-实现map方法){.header-anchor} 5 实现map方法 {#_5-实现map方法}
...
### [\#](#_6-实现reduce方法){.header-anchor} 6 实现reduce方法 {#_6-实现reduce方法}
...
### [\#](#_7-实现every方法){.header-anchor} 7 实现every方法 {#_7-实现every方法}
...
### [\#](#_8-实现some方法){.header-anchor} 8 实现some方法 {#_8-实现some方法}
...
### [\#](#_9-实现数组扁平化flat方法){.header-anchor} 9 实现数组扁平化flat方法 {#_9-实现数组扁平化flat方法}
...
### [\#](#_10-实现array-isarray方法){.header-anchor} 10 实现Array.isArray方法 {#_10-实现array-isarray方法}
...
### [\#](#_11-实现array-of方法){.header-anchor} 11 实现Array.of方法 {#_11-实现array-of方法}
...
### [\#](#_12-数组去重方法汇总){.header-anchor} 12 数组去重方法汇总 {#_12-数组去重方法汇总}
...
### [\#](#_13-对象数组如何去重){.header-anchor} 13 对象数组如何去重 {#_13-对象数组如何去重}
...
### [\#](#_14-数组中的数据根据key去重){.header-anchor} 14 数组中的数据根据key去重 {#_14-数组中的数据根据key去重}
...
### [\#](#_15-类数组转化为数组的方法){.header-anchor} 15 类数组转化为数组的方法 {#_15-类数组转化为数组的方法}
...
### [\#](#_16-reduce用法汇总){.header-anchor} 16 reduce用法汇总 {#_16-reduce用法汇总}
...
``` language-js
                                        ...
                                        const
                                        str =
                                        'sfhjasfjgfasjuwqrqadqeiqsajsdaiwqdaklldflas-cmxzmnha'
                                        ;
                                        const
                                        res =
                                        str.
...
## [\#](#_30-正则相关){.header-anchor} 30 正则相关 {#_30-正则相关}

### [\#](#_1-实现千位分隔符){.header-anchor} 1 实现千位分隔符 {#_1-实现千位分隔符}
...
### [\#](#_2-判断是否是电话号码){.header-anchor} 2 判断是否是电话号码 {#_2-判断是否是电话号码}
...
### [\#](#_3-验证是否是邮箱){.header-anchor} 3 验证是否是邮箱 {#_3-验证是否是邮箱}
...
### [\#](#_4-验证是否是身份证){.header-anchor} 4 验证是否是身份证 {#_4-验证是否是身份证}
...
### [\#](#_5-用正则写一个根据name获取cookie中的值的方法){.header-anchor} 5 用正则写一个根据name获取cookie中的值的方法 {#_5-用正则写一个根据name获取cookie中的值的方法}
...
-   `'(^| )'` 表示的就是获取每一项的开头，因为我们知道如果`^`
    不是放在`[]` 里的话就是表示开头匹配。所以这里`(^| )`
    的意思其实就被拆分为`(^)` 表示的匹配`username`
    这种情况，它前面什么都没有是一个空串(你可以把`(^)` 理解为`^`
    它后面还有一个隐藏的`''` )；而`|` 表示的就是或者是一个`""`
    (为了匹配`user-id` 开头的这种情况)
-   `+name+` 这没什么好说的
...
4.  为了防止获取到的值是`%xxx` 这样的字符序列，需要用`unescape()`
    方法解码。

## [\#](#_31-函数柯里化相关){.header-anchor} 31 函数柯里化相关 {#_31-函数柯里化相关}

### [\#](#_1-实现一个js函数柯里化){.header-anchor} 1 实现一个JS函数柯里化 {#_1-实现一个js函数柯里化}
...
### [\#](#_2-请实现一个-add-函数-满足以下功能){.header-anchor} 2 请实现一个 add 函数，满足以下功能 {#_2-请实现一个-add-函数-满足以下功能}
...
### [\#](#_3-实现-5-add-3-minus-2-功能){.header-anchor} 3 实现 (5).add(3).minus(2) 功能 {#_3-实现-5-add-3-minus-2-功能}
