# [\#](#基础篇){.header-anchor} 基础篇

> 前端基础题型，快速过一遍即可

![面试经验谈](https://s.poetries.work/uploads/2022/07/ee7310c4f45b9bd6.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/uploads/2022/07/ee7310c4f45b9bd6.png"
loading="lazy"}

## [\#](#一、html、http、web综合问题){.header-anchor} 一、HTML、HTTP、WEB综合问题 {#一、html、http、web综合问题}

### [\#](#_1-前端需要注意哪些seo){.header-anchor} 1 前端需要注意哪些SEO {#_1-前端需要注意哪些seo}
...
### [\#](#_2-img-的title和alt有什么区别){.header-anchor} 2 `<img>`的`title`和`alt`有什么区别 {#_2-img-的title和alt有什么区别}
...
### [\#](#_3-http的几种请求方法用途){.header-anchor} 3 HTTP的几种请求方法用途 {#_3-http的几种请求方法用途}
...
### [\#](#_4-从浏览器地址栏输入url到显示页面的步骤){.header-anchor} 4 从浏览器地址栏输入url到显示页面的步骤 {#_4-从浏览器地址栏输入url到显示页面的步骤}
...
7.  TCP链接建立后**发送HTTP请求**
8.  服务器接受请求并解析，将请求转发到服务程序，如虚拟主机使用HTTP
    Host头部判断请求的服务程序
...
### [\#](#_5-如何进行网站性能优化){.header-anchor} 5 如何进行网站性能优化 {#_5-如何进行网站性能优化}
...
-   减少`http`请求次数：`CSS Sprites`,
    `JS`、`CSS`源码压缩、图片大小控制合适；网页`Gzip`，`CDN`托管，`data`缓存
    ，图片服务器。
-   前端模板
    JS+数据，减少由于HTML标签导致的带宽浪费，前端用变量保存`AJAX`请求结果，每次操作本地变量，不用请求，减少请求次数
...
### [\#](#_6-http状态码及其含义){.header-anchor} 6 HTTP状态码及其含义 {#_6-http状态码及其含义}
...
### [\#](#_7-语义化的理解){.header-anchor} 7 语义化的理解 {#_7-语义化的理解}
...
### [\#](#_8-介绍一下你对浏览器内核的理解){.header-anchor} 8 介绍一下你对浏览器内核的理解？ {#_8-介绍一下你对浏览器内核的理解}
...
### [\#](#_9-html5有哪些新特性、移除了那些元素){.header-anchor} 9 html5有哪些新特性、移除了那些元素？ {#_9-html5有哪些新特性、移除了那些元素}
...
### [\#](#_10-html5的离线储存怎么使用-工作原理能不能解释一下){.header-anchor} 10 `HTML5`的离线储存怎么使用，工作原理能不能解释一下？ {#_10-html5的离线储存怎么使用-工作原理能不能解释一下}
...
### [\#](#_11-浏览器是怎么对html5的离线储存资源进行管理和加载的呢){.header-anchor} 11 浏览器是怎么对`HTML5`的离线储存资源进行管理和加载的呢 {#_11-浏览器是怎么对html5的离线储存资源进行管理和加载的呢}
...
### [\#](#_12-请描述一下-cookies-sessionstorage-和-localstorage-的区别){.header-anchor} 12 请描述一下 `cookies`，`sessionStorage` 和 `localStorage` 的区别？ {#_12-请描述一下-cookies-sessionstorage-和-localstorage-的区别}
...
### [\#](#_13-iframe有那些缺点){.header-anchor} 13 iframe有那些缺点？ {#_13-iframe有那些缺点}
...
### [\#](#_14-web标准以及w3c标准是什么){.header-anchor} 14 WEB标准以及W3C标准是什么? {#_14-web标准以及w3c标准是什么}
...
### [\#](#_15-xhtml和html有什么区别){.header-anchor} 15 xhtml和html有什么区别? {#_15-xhtml和html有什么区别}
...
### [\#](#_16-doctype作用-严格模式与混杂模式如何区分-它们有何意义){.header-anchor} 16 Doctype作用? 严格模式与混杂模式如何区分？它们有何意义? {#_16-doctype作用-严格模式与混杂模式如何区分-它们有何意义}
...
### [\#](#_17-行内元素有哪些-块级元素有哪些-空-void-元素有那些-行内元素和块级元素有什么区别){.header-anchor} 17 行内元素有哪些？块级元素有哪些？ 空(void)元素有那些？行内元素和块级元素有什么区别？ {#_17-行内元素有哪些-块级元素有哪些-空-void-元素有那些-行内元素和块级元素有什么区别}

-   行内元素有：`a` `b` `span` `img` `input` `select` `strong`等。
-   块级元素有：`div` `ul` `ol` `li` `dl` `dt` `dd` `h1` `h2` `h3`
    `h4`等标题标签、`p` 段落标签等。
-   空元素（void元素）是指没有内容的HTML元素。常见的空元素包括：`<br>`
...
### [\#](#_18-html全局属性-global-attribute-有哪些){.header-anchor} 18 HTML全局属性(global attribute)有哪些 {#_18-html全局属性-global-attribute-有哪些}
...
### [\#](#_19-canvas和svg有什么区别){.header-anchor} 19 Canvas和SVG有什么区别？ {#_19-canvas和svg有什么区别}
...
-   SVG
    使用XML描述图形，它由一系列的矢量对象组成，可以方便地修改和操作。
-   SVG
...
### [\#](#_20-html5-为什么只需要写-doctype-html){.header-anchor} 20 HTML5 为什么只需要写 `<!DOCTYPE HTML>` {#_20-html5-为什么只需要写-doctype-html}
...
### [\#](#_21-如何在页面上实现一个圆形的可点击区域){.header-anchor} 21 如何在页面上实现一个圆形的可点击区域？ {#_21-如何在页面上实现一个圆形的可点击区域}
...
### [\#](#_22-网页验证码是干嘛的-是为了解决什么安全问题){.header-anchor} 22 网页验证码是干嘛的，是为了解决什么安全问题 {#_22-网页验证码是干嘛的-是为了解决什么安全问题}
...
### [\#](#_23-viewport){.header-anchor} 23 viewport {#_23-viewport}
...
### [\#](#_24-渲染优化){.header-anchor} 24 渲染优化 {#_24-渲染优化}
...
-   前端模板
    JS+数据，减少由于`HTML`标签导致的带宽浪费，前端用变量保存AJAX请求结果，每次操作本地变量，不用请求，减少请求次数
...
### [\#](#_25-meta-viewport相关){.header-anchor} 25 meta viewport相关 {#_25-meta-viewport相关}
...
### [\#](#_26-你做的页面在哪些流览器测试过-这些浏览器的内核分别是什么){.header-anchor} 26 你做的页面在哪些流览器测试过？这些浏览器的内核分别是什么? {#_26-你做的页面在哪些流览器测试过-这些浏览器的内核分别是什么}
...
### [\#](#_27-div-css的布局较table布局有什么优点){.header-anchor} 27 div+css的布局较table布局有什么优点？ {#_27-div-css的布局较table布局有什么优点}
...
### [\#](#_28-a-img的alt与title有何异同-b-strong与em的异同){.header-anchor} 28 a：img的alt与title有何异同？b：strong与em的异同？ {#_28-a-img的alt与title有何异同-b-strong与em的异同}
...
### [\#](#_29-你能描述一下渐进增强和优雅降级之间的不同吗){.header-anchor} 29 你能描述一下渐进增强和优雅降级之间的不同吗 {#_29-你能描述一下渐进增强和优雅降级之间的不同吗}
...
### [\#](#_30-为什么利用多个域名来存储网站资源会更有效){.header-anchor} 30 为什么利用多个域名来存储网站资源会更有效？ {#_30-为什么利用多个域名来存储网站资源会更有效}
...
### [\#](#_31-简述一下src与href的区别){.header-anchor} 31 简述一下src与href的区别 {#_31-简述一下src与href的区别}
...
-   `href`属性（hypertext
    reference）用于建立当前文档和引用资源之间的关联。它通常用于链接到其他文档或外部资源，例如`<a href="https://www.example.com">Link</a>`用于创建一个指向外部网页的链接，或者`<link href="styles.css" rel="stylesheet">`用于引入外部的CSS样式表。浏览器在解析到带有`href`属性的元素时，会同时进行当前文档和引用资源的加载和处理，而不会阻塞当前文档的解析。
...
### [\#](#_32-知道的网页制作会用到的图片格式有哪些){.header-anchor} 32 知道的网页制作会用到的图片格式有哪些？ {#_32-知道的网页制作会用到的图片格式有哪些}
...
-   **SVG**（Scalable Vector
    Graphics）：矢量图形格式，使用XML描述图形，具有无损缩放和可编辑性。

除了上述常见的图片格式，还有一些新兴的图片格式：

-   **WebP**：由Google开发的一种旨在提高图片加载速度的格式，具有较高的压缩率和图像质量，逐渐被主流浏览器支持。
-   **APNG**（Animated Portable Network
    Graphics）：是PNG的位图动画扩展，支持帧动画效果，但浏览器兼容性较差。

请注意，选择合适的图片格式应根据具体需求，如图像内容、透明度要求、动画效果等。新的图片格式如WebP和APNG可以根据项目需求和兼容性考虑是否使用。

### [\#](#_33-在css-js代码上线之后-开发人员经常会优化性能。从用户刷新网页开始-一次js请求一般情况下有哪些地方会有缓存处理){.header-anchor} 33 在CSS/JS代码上线之后，开发人员经常会优化性能。从用户刷新网页开始，一次JS请求一般情况下有哪些地方会有缓存处理？ {#_33-在css-js代码上线之后-开发人员经常会优化性能。从用户刷新网页开始-一次js请求一般情况下有哪些地方会有缓存处理}
...
### [\#](#_33-一个页面上有大量的图片-大型电商网站-加载很慢-你有哪些方法优化这些图片的加载-给用户更好的体验。){.header-anchor} 33 一个页面上有大量的图片（大型电商网站），加载很慢，你有哪些方法优化这些图片的加载，给用户更好的体验。 {#_33-一个页面上有大量的图片-大型电商网站-加载很慢-你有哪些方法优化这些图片的加载-给用户更好的体验。}
...
### [\#](#_34-常见排序算法的时间复杂度-空间复杂度){.header-anchor} 34 常见排序算法的时间复杂度,空间复杂度 {#_34-常见排序算法的时间复杂度-空间复杂度}
...
![](https://s.poetries.work/cos/202204032131039.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/cos/202204032131039.png"
loading="lazy"}
![](https://s.poetries.work/uploads/2023/01/553d2314d0d81dfe.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/uploads/2023/01/553d2314d0d81dfe.png"
loading="lazy"}

### [\#](#_35-web开发中会话跟踪的方法有哪些){.header-anchor} 35 web开发中会话跟踪的方法有哪些 {#_35-web开发中会话跟踪的方法有哪些}

-   **Cookie**:
    使用Cookie是最常见的会话跟踪方法之一。服务器在响应中设置一个包含会话ID的Cookie，然后在后续的请求中，浏览器会自动将该Cookie发送回服务器，以标识用户的会话。
-   **Session**:
    服务器使用会话来跟踪用户的状态。每个会话都会分配一个唯一的会话ID，该ID通常存储在Cookie中或通过URL重写传递给服务器。服务器使用会话ID来关联用户的请求，并在服务器端存储会话数据。
-   **URL重写**:
    将会话ID作为查询参数添加到URL中，以便在每个请求中传递会话信息。这种方法不需要依赖Cookie，适用于禁用Cookie的情况，但会增加URL的长度并暴露会话信息。
-   **隐藏input**:
    在表单中添加一个隐藏的input字段，将会话ID作为其值传递给服务器。服务器接收到请求时可以通过解析请求参数获取会话ID，以进行会话跟踪。
-   **IP地址**:
    使用客户端的IP地址作为会话跟踪的依据。服务器根据不同的IP地址来区分不同的用户，并跟踪他们的会话状态。然而，由于多个用户可能共享相同的IP地址（如在同一局域网内），这种方法可能不准确。

这些方法可以单独或结合使用，根据实际需求和安全考虑选择适当的会话跟踪方法。

### [\#](#_36-http-request报文结构是怎样的){.header-anchor} 36 HTTP request报文结构是怎样的 {#_36-http-request报文结构是怎样的}
...
### [\#](#_37-http-response报文结构是怎样的){.header-anchor} 37 HTTP response报文结构是怎样的 {#_37-http-response报文结构是怎样的}
...
### [\#](#_38-title与h1的区别、b与strong的区别、i与em的区别){.header-anchor} 38 title与h1的区别、b与strong的区别、i与em的区别 {#_38-title与h1的区别、b与strong的区别、i与em的区别}
...
### [\#](#_39-请你谈谈cookie的弊端){.header-anchor} 39 请你谈谈Cookie的弊端 {#_39-请你谈谈cookie的弊端}
...
### [\#](#_40-git-fetch和git-pull的区别){.header-anchor} 40 git fetch和git pull的区别 {#_40-git-fetch和git-pull的区别}
...
### [\#](#_41-http2-0-做了哪些改进-http3-0-呢){.header-anchor} 41 http2.0 做了哪些改进 http3.0 呢 {#_41-http2-0-做了哪些改进-http3-0-呢}
...
## [\#](#二、css相关){.header-anchor} 二、CSS相关 {#二、css相关}

### [\#](#_1-css-sprite是什么-有什么优缺点){.header-anchor} 1 css sprite是什么,有什么优缺点 {#_1-css-sprite是什么-有什么优缺点}
...
### [\#](#_2-display-none-与visibility-hidden-的区别){.header-anchor} 2 `display: none;`与`visibility: hidden;`的区别 {#_2-display-none-与visibility-hidden-的区别}
...
### [\#](#_3-link与-import的区别){.header-anchor} 3 `link`与`@import`的区别 {#_3-link与-import的区别}
...
### [\#](#_4-什么是fouc-如何避免){.header-anchor} 4 什么是FOUC?如何避免 {#_4-什么是fouc-如何避免}
...
### [\#](#_5-如何创建块级格式化上下文-block-formatting-context-bfc有什么用){.header-anchor} 5 如何创建块级格式化上下文(block formatting context),BFC有什么用 {#_5-如何创建块级格式化上下文-block-formatting-context-bfc有什么用}
...
### [\#](#_6-display、float、position的关系){.header-anchor} 6 display、float、position的关系 {#_6-display、float、position的关系}
...
![](https://s.poetries.work/images/202202231030963.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/202202231030963.png"
loading="lazy"}

综上所述，display、float和position之间存在一定的关系，它们的取值会相互影响元素的布局和显示方式。根据不同的取值组合，元素的display值可能会被调整。

### [\#](#_7-清除浮动的几种方式-各自的优缺点){.header-anchor} 7 清除浮动的几种方式，各自的优缺点 {#_7-清除浮动的几种方式-各自的优缺点}
...
### [\#](#_8-为什么要初始化css样式){.header-anchor} 8 为什么要初始化CSS样式? {#_8-为什么要初始化css样式}
...
### [\#](#_9-css3有哪些新特性){.header-anchor} 9 css3有哪些新特性 {#_9-css3有哪些新特性}
...
### [\#](#_10-display有哪些值-说明他们的作用){.header-anchor} 10 display有哪些值？说明他们的作用 {#_10-display有哪些值-说明他们的作用}
...
### [\#](#_11-介绍一下标准的css的盒子模型-低版本ie的盒子模型有什么不同的){.header-anchor} 11 介绍一下标准的CSS的盒子模型？低版本IE的盒子模型有什么不同的？ {#_11-介绍一下标准的css的盒子模型-低版本ie的盒子模型有什么不同的}
...
### [\#](#_12-css优先级算法如何计算){.header-anchor} 12 CSS优先级算法如何计算？ {#_12-css优先级算法如何计算}
...
### [\#](#_13-对bfc规范的理解){.header-anchor} 13 对BFC规范的理解？ {#_13-对bfc规范的理解}
...
### [\#](#_14-谈谈浮动和清除浮动){.header-anchor} 14 谈谈浮动和清除浮动 {#_14-谈谈浮动和清除浮动}
...
### [\#](#_15-position的值-relative和absolute定位原点是){.header-anchor} 15 position的值， relative和absolute定位原点是 {#_15-position的值-relative和absolute定位原点是}
...
### [\#](#_16-display-inline-block-什么时候不会显示间隙){.header-anchor} 16 display:inline-block 什么时候不会显示间隙？ {#_16-display-inline-block-什么时候不会显示间隙}
...
### [\#](#_17-png-gif-jpg的区别及如何选){.header-anchor} 17 PNG\\GIF\\JPG的区别及如何选 {#_17-png-gif-jpg的区别及如何选}
...
### [\#](#_18-行内元素float-left后是否变为块级元素){.header-anchor} 18 行内元素float:left后是否变为块级元素？ {#_18-行内元素float-left后是否变为块级元素}
...
### [\#](#_19-在网页中的应该使用奇数还是偶数的字体-为什么呢){.header-anchor} 19 在网页中的应该使用奇数还是偶数的字体？为什么呢？ {#_19-在网页中的应该使用奇数还是偶数的字体-为什么呢}
...
### [\#](#_20-before-和-after中双冒号和单冒号-有什么区别-解释一下这2个伪元素的作用){.header-anchor} 20 ::before 和 :after中双冒号和单冒号 有什么区别？解释一下这2个伪元素的作用 {#_20-before-和-after中双冒号和单冒号-有什么区别-解释一下这2个伪元素的作用}
...
### [\#](#_21-如果需要手动写动画-你认为最小时间间隔是多久-为什么-阿里){.header-anchor} 21 如果需要手动写动画，你认为最小时间间隔是多久，为什么？（阿里） {#_21-如果需要手动写动画-你认为最小时间间隔是多久-为什么-阿里}
...
### [\#](#_22-css合并方法){.header-anchor} 22 CSS合并方法 {#_22-css合并方法}
...
### [\#](#_23-css不同选择器的权重-css层叠的规则){.header-anchor} 23 CSS不同选择器的权重(CSS层叠的规则) {#_23-css不同选择器的权重-css层叠的规则}
...
### [\#](#_24-列出你所知道可以改变页面布局的属性){.header-anchor} 24 列出你所知道可以改变页面布局的属性 {#_24-列出你所知道可以改变页面布局的属性}
...
### [\#](#_25-css在性能优化方面的实践){.header-anchor} 25 CSS在性能优化方面的实践 {#_25-css在性能优化方面的实践}
...
### [\#](#_26-css3动画-简单动画的实现-如旋转等){.header-anchor} 26 CSS3动画（简单动画的实现，如旋转等） {#_26-css3动画-简单动画的实现-如旋转等}
...
### [\#](#_27-base64的原理及优缺点){.header-anchor} 27 base64的原理及优缺点 {#_27-base64的原理及优缺点}
...
### [\#](#_28-几种常见的css布局){.header-anchor} 28 几种常见的CSS布局 {#_28-几种常见的css布局}

#### [\#](#流体布局){.header-anchor} 流体布局
...
### [\#](#_29-stylus-sass-less区别){.header-anchor} 29 stylus/sass/less区别 {#_29-stylus-sass-less区别}
...
### [\#](#_30-postcss的作用){.header-anchor} 30 postcss的作用 {#_30-postcss的作用}
...
### [\#](#_31-css样式-选择器-的优先级){.header-anchor} 31 css样式（选择器）的优先级 {#_31-css样式-选择器-的优先级}
...
### [\#](#_32-自定义字体的使用场景){.header-anchor} 32 自定义字体的使用场景 {#_32-自定义字体的使用场景}
...
### [\#](#_33-如何美化checkbox){.header-anchor} 33 如何美化CheckBox {#_33-如何美化checkbox}
...
### [\#](#_34-伪类和伪元素的区别){.header-anchor} 34 伪类和伪元素的区别 {#_34-伪类和伪元素的区别}
...
### [\#](#_35-base64的使用){.header-anchor} 35 `base64`的使用 {#_35-base64的使用}
...
### [\#](#_36-自适应布局){.header-anchor} 36 自适应布局 {#_36-自适应布局}
...
### [\#](#_37-请用css写一个简单的幻灯片效果页面){.header-anchor} 37 请用CSS写一个简单的幻灯片效果页面 {#_37-请用css写一个简单的幻灯片效果页面}
...
### [\#](#_38-什么是外边距重叠-重叠的结果是什么){.header-anchor} 38 什么是外边距重叠？重叠的结果是什么？ {#_38-什么是外边距重叠-重叠的结果是什么}
...
### [\#](#_39-rgba-和opacity的透明效果有什么不同){.header-anchor} 39 rgba()和opacity的透明效果有什么不同？ {#_39-rgba-和opacity的透明效果有什么不同}
...
### [\#](#_40-css中可以让文字在垂直和水平方向上重叠的两个属性是什么){.header-anchor} 40 css中可以让文字在垂直和水平方向上重叠的两个属性是什么？ {#_40-css中可以让文字在垂直和水平方向上重叠的两个属性是什么}
...
### [\#](#_41-如何垂直居中一个浮动元素){.header-anchor} 41 如何垂直居中一个浮动元素？ {#_41-如何垂直居中一个浮动元素}
...
### [\#](#_42-px和em的区别){.header-anchor} 42 px和em的区别 {#_42-px和em的区别}
...
### [\#](#_43-sass、less是什么-大家为什么要使用他们){.header-anchor} 43 Sass、LESS是什么？大家为什么要使用他们？ {#_43-sass、less是什么-大家为什么要使用他们}
...
### [\#](#_44-知道css有个content属性吗-有什么作用-有什么应用){.header-anchor} 44 知道css有个content属性吗？有什么作用？有什么应用？ {#_44-知道css有个content属性吗-有什么作用-有什么应用}
...
### [\#](#_45-水平居中的方法){.header-anchor} 45 水平居中的方法 {#_45-水平居中的方法}
...
### [\#](#_46-垂直居中的方法){.header-anchor} 46 垂直居中的方法 {#_46-垂直居中的方法}
...
### [\#](#_47-如何使用css实现硬件加速){.header-anchor} 47 如何使用CSS实现硬件加速？ {#_47-如何使用css实现硬件加速}
...
### [\#](#_48-重绘和回流-重排-是什么-如何避免){.header-anchor} 48 重绘和回流（重排）是什么，如何避免？ {#_48-重绘和回流-重排-是什么-如何避免}
...
### [\#](#_49-说一说css3的animation){.header-anchor} 49 说一说css3的animation {#_49-说一说css3的animation}
...
### [\#](#_50-左边宽度固定-右边自适应){.header-anchor} 50 左边宽度固定，右边自适应 {#_50-左边宽度固定-右边自适应}
...
### [\#](#_51-两种以上方式实现已知或者未知宽度的垂直水平居中){.header-anchor} 51 两种以上方式实现已知或者未知宽度的垂直水平居中 {#_51-两种以上方式实现已知或者未知宽度的垂直水平居中}
...
### [\#](#_52-如何实现小于12px的字体效果){.header-anchor} 52 如何实现小于12px的字体效果 {#_52-如何实现小于12px的字体效果}
...
### [\#](#_53-css-hack原理及常用hack){.header-anchor} 53 css hack原理及常用hack {#_53-css-hack原理及常用hack}
...
### [\#](#_54-css有哪些继承属性){.header-anchor} 54 CSS有哪些继承属性 {#_54-css有哪些继承属性}
...
### [\#](#_55-外边距折叠-collapsing-margins){.header-anchor} 55 外边距折叠(collapsing margins) {#_55-外边距折叠-collapsing-margins}
...
### [\#](#_56-css选择符有哪些-哪些属性可以继承){.header-anchor} 56 CSS选择符有哪些？哪些属性可以继承 {#_56-css选择符有哪些-哪些属性可以继承}
...
### [\#](#_57-css3新增伪类有那些){.header-anchor} 57 CSS3新增伪类有那些 {#_57-css3新增伪类有那些}
...
### [\#](#_58-如何居中div-如何居中一个浮动元素-如何让绝对定位的div居中){.header-anchor} 58 如何居中div？如何居中一个浮动元素？如何让绝对定位的div居中 {#_58-如何居中div-如何居中一个浮动元素-如何让绝对定位的div居中}
...
### [\#](#_59-用纯css创建一个三角形的原理是什么){.header-anchor} 59 用纯CSS创建一个三角形的原理是什么 {#_59-用纯css创建一个三角形的原理是什么}
...
### [\#](#_60-一个满屏-品-字布局-如何设计){.header-anchor} 60 一个满屏 品 字布局 如何设计? {#_60-一个满屏-品-字布局-如何设计}
...
### [\#](#_61-li与li之间有看不见的空白间隔是什么原因引起的-有什么解决办法){.header-anchor} 61 li与li之间有看不见的空白间隔是什么原因引起的？有什么解决办法 {#_61-li与li之间有看不见的空白间隔是什么原因引起的-有什么解决办法}
...
### [\#](#_62-请列举几种隐藏元素的方法){.header-anchor} 62 请列举几种隐藏元素的方法 {#_62-请列举几种隐藏元素的方法}
...
### [\#](#_63-rgba-和-opacity-的透明效果有什么不同){.header-anchor} 63 rgba() 和 opacity 的透明效果有什么不同 {#_63-rgba-和-opacity-的透明效果有什么不同}
...
### [\#](#_64-css-属性-content-有什么作用){.header-anchor} 64 css 属性 content 有什么作用 {#_64-css-属性-content-有什么作用}
...
### [\#](#_65-请解释一下-css3-的-flexbox-弹性盒布局模型-以及适用场景){.header-anchor} 65 请解释一下 CSS3 的 Flexbox（弹性盒布局模型）以及适用场景 {#_65-请解释一下-css3-的-flexbox-弹性盒布局模型-以及适用场景}
...
### [\#](#_66-经常遇到的浏览器的js兼容性有哪些-解决方法是什么){.header-anchor} 66 经常遇到的浏览器的JS兼容性有哪些？解决方法是什么 {#_66-经常遇到的浏览器的js兼容性有哪些-解决方法是什么}
...
### [\#](#_67-请写出多种等高布局){.header-anchor} 67 请写出多种等高布局 {#_67-请写出多种等高布局}
...
### [\#](#_68-浮动元素引起的问题){.header-anchor} 68 浮动元素引起的问题 {#_68-浮动元素引起的问题}
...
### [\#](#_69-css优化、提高性能的方法有哪些){.header-anchor} 69 CSS优化、提高性能的方法有哪些 {#_69-css优化、提高性能的方法有哪些}
...
### [\#](#_70-浏览器是怎样解析css选择器的){.header-anchor} 70 浏览器是怎样解析CSS选择器的 {#_70-浏览器是怎样解析css选择器的}
...
### [\#](#_71-在网页中的应该使用奇数还是偶数的字体){.header-anchor} 71 在网页中的应该使用奇数还是偶数的字体 {#_71-在网页中的应该使用奇数还是偶数的字体}
...
### [\#](#_72-margin和padding分别适合什么场景使用){.header-anchor} 72 margin和padding分别适合什么场景使用 {#_72-margin和padding分别适合什么场景使用}
...
### [\#](#_73-抽离样式模块怎么写-说出思路){.header-anchor} 73 抽离样式模块怎么写，说出思路 {#_73-抽离样式模块怎么写-说出思路}
...
### [\#](#_74-元素竖向的百分比设定是相对于容器的高度吗){.header-anchor} 74 元素竖向的百分比设定是相对于容器的高度吗 {#_74-元素竖向的百分比设定是相对于容器的高度吗}
...
### [\#](#_75-全屏滚动的原理是什么-用到了css的那些属性){.header-anchor} 75 全屏滚动的原理是什么？ 用到了CSS的那些属性 {#_75-全屏滚动的原理是什么-用到了css的那些属性}
...
### [\#](#_76-什么是响应式设计-响应式设计的基本原理是什么-如何兼容低版本的ie){.header-anchor} 76 什么是响应式设计？响应式设计的基本原理是什么？如何兼容低版本的IE {#_76-什么是响应式设计-响应式设计的基本原理是什么-如何兼容低版本的ie}
...
### [\#](#_77-什么是视差滚动效果-如何给每页做不同的动画){.header-anchor} 77 什么是视差滚动效果，如何给每页做不同的动画 {#_77-什么是视差滚动效果-如何给每页做不同的动画}
...
### [\#](#_78-a标签上四个伪类的执行顺序是怎么样的){.header-anchor} 78 a标签上四个伪类的执行顺序是怎么样的 {#_78-a标签上四个伪类的执行顺序是怎么样的}
...
### [\#](#_79-伪元素和伪类的区别和作用){.header-anchor} 79 伪元素和伪类的区别和作用 {#_79-伪元素和伪类的区别和作用}
...
### [\#](#_80-before-和-after-中双冒号和单冒号有什么区别){.header-anchor} 80 ::before 和 :after 中双冒号和单冒号有什么区别 {#_80-before-和-after-中双冒号和单冒号有什么区别}
...
### [\#](#_81-如何修改chrome记住密码后自动填充表单的黄色背景){.header-anchor} 81 如何修改Chrome记住密码后自动填充表单的黄色背景 {#_81-如何修改chrome记住密码后自动填充表单的黄色背景}
...
### [\#](#_82-网站图片文件-如何点击下载-而非点击预览){.header-anchor} 82 网站图片文件，如何点击下载？而非点击预览 {#_82-网站图片文件-如何点击下载-而非点击预览}
...
### [\#](#_83-你对-line-height-是如何理解的){.header-anchor} 83 你对 line-height 是如何理解的 {#_83-你对-line-height-是如何理解的}
...
### [\#](#_84-line-height-三种赋值方式有何区别-带单位、纯数字、百分比){.header-anchor} 84 line-height 三种赋值方式有何区别？（带单位、纯数字、百分比） {#_84-line-height-三种赋值方式有何区别-带单位、纯数字、百分比}
...
### [\#](#_85-设置元素浮动后-该元素的-display-值会如何变化){.header-anchor} 85 设置元素浮动后，该元素的 display 值会如何变化 {#_85-设置元素浮动后-该元素的-display-值会如何变化}
...
### [\#](#_86-让页面里的字体变清晰-变细用css怎么做-ios手机浏览器字体齿轮设置){.header-anchor} 86 让页面里的字体变清晰，变细用CSS怎么做？（IOS手机浏览器字体齿轮设置） {#_86-让页面里的字体变清晰-变细用css怎么做-ios手机浏览器字体齿轮设置}
...
### [\#](#_87-font-style-属性-oblique-是什么意思){.header-anchor} 87 font-style 属性 oblique 是什么意思 {#_87-font-style-属性-oblique-是什么意思}
...
### [\#](#_88-display-inline-block-什么时候会显示间隙){.header-anchor} 88 display:inline-block 什么时候会显示间隙 {#_88-display-inline-block-什么时候会显示间隙}
...
### [\#](#_89-一个高度自适应的div-里面有两个div-一个高度100px-希望另一个填满剩下的高度){.header-anchor} 89 一个高度自适应的div，里面有两个div，一个高度100px，希望另一个填满剩下的高度 {#_89-一个高度自适应的div-里面有两个div-一个高度100px-希望另一个填满剩下的高度}
...
### [\#](#_90-css-的渲染层合成是什么-浏览器如何创建新的渲染层){.header-anchor} 90 css 的渲染层合成是什么 浏览器如何创建新的渲染层 {#_90-css-的渲染层合成是什么-浏览器如何创建新的渲染层}
...
## [\#](#三、javascript相关){.header-anchor} 三、JavaScript相关 {#三、javascript相关}

### [\#](#_1-闭包){.header-anchor} 1 闭包 {#_1-闭包}
...
### [\#](#_2-说说你对作用域链的理解){.header-anchor} 2 说说你对作用域链的理解 {#_2-说说你对作用域链的理解}
...
### [\#](#_3-javascript原型-原型链-有什么特点){.header-anchor} 3 JavaScript原型，原型链 ? 有什么特点？ {#_3-javascript原型-原型链-有什么特点}
...
### [\#](#_4-请解释什么是事件代理){.header-anchor} 4 请解释什么是事件代理 {#_4-请解释什么是事件代理}
...
### [\#](#_5-javascript如何实现继承){.header-anchor} 5 Javascript如何实现继承？ {#_5-javascript如何实现继承}
...
### [\#](#_6-谈谈this对象的理解){.header-anchor} 6 谈谈This对象的理解 {#_6-谈谈this对象的理解}
...
### [\#](#_7-事件模型){.header-anchor} 7 事件模型 {#_7-事件模型}
...
### [\#](#_8-new操作符具体干了什么呢){.header-anchor} 8 new操作符具体干了什么呢? {#_8-new操作符具体干了什么呢}
...
### [\#](#_9-ajax原理){.header-anchor} 9 Ajax原理 {#_9-ajax原理}
...
### [\#](#_10-如何解决跨域问题){.header-anchor} 10 如何解决跨域问题? {#_10-如何解决跨域问题}
...
::: {.language-nginx .extra-class}
``` {.language-nginx .code-copy-added}
server {
    listen 80;
...
### [\#](#_11-模块化开发怎么做){.header-anchor} 11 模块化开发怎么做？ {#_11-模块化开发怎么做}
...
### [\#](#_12-异步加载js的方式有哪些){.header-anchor} 12 异步加载JS的方式有哪些？ {#_12-异步加载js的方式有哪些}
...
### [\#](#_13-那些操作会造成内存泄漏){.header-anchor} 13 那些操作会造成内存泄漏？ {#_13-那些操作会造成内存泄漏}
...
### [\#](#_14-xml和json的区别){.header-anchor} 14 XML和JSON的区别？ {#_14-xml和json的区别}
...
### [\#](#_15-谈谈你对webpack的看法){.header-anchor} 15 谈谈你对webpack的看法 {#_15-谈谈你对webpack的看法}
...
4.  **开发工具支持**：Webpack提供了开发工具和开发服务器，支持热模块替换（Hot
    Module
...
### [\#](#_16-说说你对amd和commonjs的理解){.header-anchor} 16 说说你对AMD和Commonjs的理解 {#_16-说说你对amd和commonjs的理解}
...
### [\#](#_17-常见web安全及防护原理){.header-anchor} 17 常见web安全及防护原理 {#_17-常见web安全及防护原理}
...
### [\#](#_18-用过哪些设计模式){.header-anchor} 18 用过哪些设计模式？ {#_18-用过哪些设计模式}
...
### [\#](#_19-为什么要有同源限制){.header-anchor} 19 为什么要有同源限制？ {#_19-为什么要有同源限制}
...
### [\#](#_20-offsetwidth-offsetheight-clientwidth-clientheight与scrollwidth-scrollheight的区别){.header-anchor} 20 offsetWidth/offsetHeight,clientWidth/clientHeight与scrollWidth/scrollHeight的区别 {#_20-offsetwidth-offsetheight-clientwidth-clientheight与scrollwidth-scrollheight的区别}
...
### [\#](#_21-javascript有哪些方法定义对象){.header-anchor} 21 javascript有哪些方法定义对象 {#_21-javascript有哪些方法定义对象}
...
### [\#](#_22-常见兼容性问题){.header-anchor} 22 常见兼容性问题？ {#_22-常见兼容性问题}

常见的兼容性问题有很多，以下列举一些常见的问题：

1.  **浏览器的盒模型差异**：不同浏览器对盒模型的解析存在差异，导致元素的尺寸计算不一致。可以使用CSS盒模型属性（`box-sizing`）来进行控制。
2.  **浏览器对CSS属性的支持差异**：不同浏览器对CSS属性的支持程度不同，某些属性在某些浏览器中可能不起作用或解析不正确。需要使用CSS前缀（Vendor
    Prefix）或使用兼容性方案来处理。
3.  **JavaScript API的差异**：不同浏览器对JavaScript
...
### [\#](#_23-说说你对promise的了解){.header-anchor} 23 说说你对promise的了解 {#_23-说说你对promise的了解}
...
### [\#](#_24-你觉得jquery源码有哪些写的好的地方){.header-anchor} 24 你觉得jQuery源码有哪些写的好的地方 {#_24-你觉得jquery源码有哪些写的好的地方}
...
### [\#](#_25-谈谈你对vue、react、angular的理解){.header-anchor} 25 谈谈你对vue、react、angular的理解 {#_25-谈谈你对vue、react、angular的理解}
...
### [\#](#_26-node的应用场景){.header-anchor} 26 Node的应用场景 {#_26-node的应用场景}
...
### [\#](#_27-谈谈你对amd、cmd的理解){.header-anchor} 27 谈谈你对AMD、CMD的理解 {#_27-谈谈你对amd、cmd的理解}
...
### [\#](#_28-那些操作会造成内存泄漏){.header-anchor} 28 那些操作会造成内存泄漏 {#_28-那些操作会造成内存泄漏}
...
### [\#](#_29-web开发中会话跟踪的方法有哪些){.header-anchor} 29 web开发中会话跟踪的方法有哪些 {#_29-web开发中会话跟踪的方法有哪些}
...
### [\#](#_30-js的基本数据类型和引用数据类型){.header-anchor} 30 JS的基本数据类型和引用数据类型 {#_30-js的基本数据类型和引用数据类型}
...
### [\#](#_31-介绍js有哪些内置对象){.header-anchor} 31 介绍js有哪些内置对象 {#_31-介绍js有哪些内置对象}
...
### [\#](#_32-说几条写javascript的基本规范){.header-anchor} 32 说几条写JavaScript的基本规范 {#_32-说几条写javascript的基本规范}
...
### [\#](#_33-javascript有几种类型的值){.header-anchor} 33 JavaScript有几种类型的值 {#_33-javascript有几种类型的值}
...
### [\#](#_34-eval是做什么的){.header-anchor} 34 eval是做什么的 {#_34-eval是做什么的}
...
### [\#](#_35-null-undefined-的区别){.header-anchor} 35 null，undefined 的区别 {#_35-null-undefined-的区别}
...
### [\#](#_36-1-2-3-map-parseint-答案是多少){.header-anchor} 36 \[\"1\", \"2\", \"3\"\].map(parseInt) 答案是多少 {#_36-1-2-3-map-parseint-答案是多少}
...
### [\#](#_37-javascript-代码中的-use-strict-是什么意思){.header-anchor} 37 javascript 代码中的\"use strict\";是什么意思 {#_37-javascript-代码中的-use-strict-是什么意思}
...
### [\#](#_38-json-的了解){.header-anchor} 38 JSON 的了解 {#_38-json-的了解}
...
1.  **数据格式简单明确**：JSON使用键值对（key-value
...
### [\#](#_39-js延迟加载的方式有哪些){.header-anchor} 39 js延迟加载的方式有哪些 {#_39-js延迟加载的方式有哪些}
...
### [\#](#_40-同步和异步的区别){.header-anchor} 40 同步和异步的区别 {#_40-同步和异步的区别}
...
### [\#](#_41-defer和async){.header-anchor} 41 defer和async {#_41-defer和async}
...
### [\#](#_42-说说严格模式的限制){.header-anchor} 42 说说严格模式的限制 {#_42-说说严格模式的限制}
...
### [\#](#_43-attribute和property的区别是什么){.header-anchor} 43 attribute和property的区别是什么 {#_43-attribute和property的区别是什么}
...
### [\#](#_44-谈谈你对es6的理解){.header-anchor} 44 谈谈你对ES6的理解 {#_44-谈谈你对es6的理解}
...
### [\#](#_45-什么是面向对象编程及面向过程编程-它们的异同和优缺点){.header-anchor} 45 什么是面向对象编程及面向过程编程，它们的异同和优缺点 {#_45-什么是面向对象编程及面向过程编程-它们的异同和优缺点}
...
### [\#](#_46-面向对象编程思想){.header-anchor} 46 面向对象编程思想 {#_46-面向对象编程思想}
...
### [\#](#_47-对web标准、可用性、可访问性的理解){.header-anchor} 47 对web标准、可用性、可访问性的理解 {#_47-对web标准、可用性、可访问性的理解}
...
### [\#](#_48-如何通过js判断一个数组){.header-anchor} 48 如何通过JS判断一个数组 {#_48-如何通过js判断一个数组}
...
### [\#](#_49-谈一谈let与var的区别){.header-anchor} 49 谈一谈let与var的区别 {#_49-谈一谈let与var的区别}
...
### [\#](#_50-map与foreach的区别){.header-anchor} 50 map与forEach的区别 {#_50-map与foreach的区别}
...
### [\#](#_51-谈一谈你理解的函数式编程){.header-anchor} 51 谈一谈你理解的函数式编程 {#_51-谈一谈你理解的函数式编程}
...
### [\#](#_52-谈一谈箭头函数与普通函数的区别){.header-anchor} 52 谈一谈箭头函数与普通函数的区别？ {#_52-谈一谈箭头函数与普通函数的区别}
...
### [\#](#_53-谈一谈函数中this的指向){.header-anchor} 53 谈一谈函数中this的指向 {#_53-谈一谈函数中this的指向}
...
### [\#](#_54-异步编程的实现方式){.header-anchor} 54 异步编程的实现方式 {#_54-异步编程的实现方式}
...
### [\#](#_56-谈谈你对原生javascript了解程度){.header-anchor} 56 谈谈你对原生Javascript了解程度 {#_56-谈谈你对原生javascript了解程度}
...
### [\#](#_57-js动画与css动画区别及相应实现){.header-anchor} 57 Js动画与CSS动画区别及相应实现 {#_57-js动画与css动画区别及相应实现}
...
3.  使用现代JavaScript动画库，如`GSAP`（GreenSock Animation
...
### [\#](#_58-js-数组和对象的遍历方式-以及几种方式的比较){.header-anchor} 58 JS 数组和对象的遍历方式，以及几种方式的比较 {#_58-js-数组和对象的遍历方式-以及几种方式的比较}
...
### [\#](#_59-gulp是什么){.header-anchor} 59 gulp是什么 {#_59-gulp是什么}
...
### [\#](#_60-说一下vue的双向绑定数据的原理){.header-anchor} 60 说一下Vue的双向绑定数据的原理 {#_60-说一下vue的双向绑定数据的原理}
...
### [\#](#_61-let-var-const区别){.header-anchor} 61 let var const区别 {#_61-let-var-const区别}
...
### [\#](#_62-快速的让一个数组乱序){.header-anchor} 62 快速的让一个数组乱序 {#_62-快速的让一个数组乱序}
...
### [\#](#_63-如何渲染几万条数据并不卡住界面){.header-anchor} 63 如何渲染几万条数据并不卡住界面 {#_63-如何渲染几万条数据并不卡住界面}
...
### [\#](#_64-希望获取到页面中所有的checkbox怎么做){.header-anchor} 64 希望获取到页面中所有的checkbox怎么做？ {#_64-希望获取到页面中所有的checkbox怎么做}
...
### [\#](#_65-怎样添加、移除、移动、复制、创建和查找节点){.header-anchor} 65 怎样添加、移除、移动、复制、创建和查找节点 {#_65-怎样添加、移除、移动、复制、创建和查找节点}
...
### [\#](#_66-正则表达式){.header-anchor} 66 正则表达式 {#_66-正则表达式}
...
### [\#](#_67-javascript中callee和caller的作用){.header-anchor} 67 Javascript中callee和caller的作用？ {#_67-javascript中callee和caller的作用}
...
### [\#](#_68-window-onload和-document-ready){.header-anchor} 68 window.onload和\$(document).ready {#_68-window-onload和-document-ready}
...
### [\#](#_69-addeventlistener-和attachevent-的区别){.header-anchor} 69 addEventListener()和attachEvent()的区别 {#_69-addeventlistener-和attachevent-的区别}
...
### [\#](#_70-获取页面所有的checkbox){.header-anchor} 70 获取页面所有的checkbox {#_70-获取页面所有的checkbox}
...
### [\#](#_71-数组去重方法总结){.header-anchor} 71 数组去重方法总结 {#_71-数组去重方法总结}
...
### [\#](#_72-设计题-想实现一个对页面某个节点的拖曳-如何做-使用原生js){.header-anchor} 72 （设计题）想实现一个对页面某个节点的拖曳？如何做？（使用原生JS） {#_72-设计题-想实现一个对页面某个节点的拖曳-如何做-使用原生js}
...
### [\#](#_73-javascript全局函数和全局变量){.header-anchor} 73 Javascript全局函数和全局变量 {#_73-javascript全局函数和全局变量}
...
### [\#](#_74-使用js实现一个持续的动画效果){.header-anchor} 74 使用js实现一个持续的动画效果 {#_74-使用js实现一个持续的动画效果}
...
### [\#](#_75-封装一个函数-参数是定时器的时间-then执行回调函数){.header-anchor} 75 封装一个函数，参数是定时器的时间，.then执行回调函数 {#_75-封装一个函数-参数是定时器的时间-then执行回调函数}
...
### [\#](#_76-怎么判断两个对象相等){.header-anchor} 76 怎么判断两个对象相等？ {#_76-怎么判断两个对象相等}
...
### [\#](#_77-项目做过哪些性能优化){.header-anchor} 77 项目做过哪些性能优化？ {#_77-项目做过哪些性能优化}
...
### [\#](#_78-浏览器缓存){.header-anchor} 78 浏览器缓存 {#_78-浏览器缓存}
...
### [\#](#_79-谈谈你对websocket的理解){.header-anchor} 79 谈谈你对WebSocket的理解 {#_79-谈谈你对websocket的理解}
...
### [\#](#_80-尽可能多的说出你对-electron-的理解){.header-anchor} 80 尽可能多的说出你对 Electron 的理解 {#_80-尽可能多的说出你对-electron-的理解}
...
### [\#](#_81-深浅拷贝){.header-anchor} 81 深浅拷贝 {#_81-深浅拷贝}
...
### [\#](#_82-防抖-节流){.header-anchor} 82 防抖/节流 {#_82-防抖-节流}
...
![](https://s.poetries.work/uploads/2022/07/e47703fd75859ad8.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/uploads/2022/07/e47703fd75859ad8.png"
loading="lazy"}
![](https://s.poetries.work/uploads/2023/01/b6ce0bd8b072ae9c.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/uploads/2023/01/b6ce0bd8b072ae9c.png"
loading="lazy"}
...
![](https://s.poetries.work/uploads/2022/07/0abcf5e689d2716b.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/uploads/2022/07/0abcf5e689d2716b.png"
loading="lazy"}
![](https://s.poetries.work/uploads/2023/01/07fded84cc81ece4.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/uploads/2023/01/07fded84cc81ece4.png"
loading="lazy"}
...
### [\#](#_83-谈谈变量提升){.header-anchor} 83 谈谈变量提升？ {#_83-谈谈变量提升}
...
### [\#](#_84-什么是单线程-和异步的关系){.header-anchor} 84 什么是单线程，和异步的关系 {#_84-什么是单线程-和异步的关系}
...
### [\#](#_85-前端面试之hybrid){.header-anchor} 85 前端面试之hybrid {#_85-前端面试之hybrid}
...
### [\#](#_86-前端面试之组件化){.header-anchor} 86 前端面试之组件化 {#_86-前端面试之组件化}
...
### [\#](#_87-前端面试之mvvm浅析){.header-anchor} 87 前端面试之MVVM浅析 {#_87-前端面试之mvvm浅析}
...
### [\#](#_88-实现效果-点击容器内的图标-图标边框变成border-1px-solid-red-点击空白处重置){.header-anchor} 88 实现效果，点击容器内的图标，图标边框变成border 1px solid red，点击空白处重置 {#_88-实现效果-点击容器内的图标-图标边框变成border-1px-solid-red-点击空白处重置}
...
### [\#](#_89-请简单实现双向数据绑定mvvm){.header-anchor} 89 请简单实现双向数据绑定MVVM {#_89-请简单实现双向数据绑定mvvm}
...
### [\#](#_90-实现storage-使得该对象为单例-并对localstorage进行封装设置值setitem-key-value-和getitem-key){.header-anchor} 90 实现Storage，使得该对象为单例，并对`localStorage`进行封装设置值setItem(key,value)和getItem(key) {#_90-实现storage-使得该对象为单例-并对localstorage进行封装设置值setitem-key-value-和getitem-key}
...
### [\#](#_91-谈谈你对event-loop的理解){.header-anchor} 91 谈谈你对Event Loop的理解 {#_91-谈谈你对event-loop的理解}
...
![](https://s.poetries.work/gitee/2020/09/101.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/09/101.png" loading="lazy"}
...
### [\#](#_92-javascript-对象生命周期的理解){.header-anchor} 92 JavaScript 对象生命周期的理解 {#_92-javascript-对象生命周期的理解}
...
### [\#](#_93-我现在有一个canvas-上面随机布着一些黑块-请实现方法-计算canvas上有多少个黑块){.header-anchor} 93 我现在有一个`canvas`，上面随机布着一些黑块，请实现方法，计算canvas上有多少个黑块 {#_93-我现在有一个canvas-上面随机布着一些黑块-请实现方法-计算canvas上有多少个黑块}
...
### [\#](#_94-现在要你完成一个dialog组件-说说你设计的思路-它应该有什么功能){.header-anchor} 94 现在要你完成一个Dialog组件，说说你设计的思路？它应该有什么功能？ {#_94-现在要你完成一个dialog组件-说说你设计的思路-它应该有什么功能}
...
::: {.language-jsx .extra-class}
``` {.language-jsx .code-copy-added}
...
### [\#](#_95-ajax、axios、fetch区别){.header-anchor} 95 ajax、axios、fetch区别 {#_95-ajax、axios、fetch区别}
...
### [\#](#_96-javascript的组成){.header-anchor} 96 JavaScript的组成 {#_96-javascript的组成}
...
### [\#](#_97-检测浏览器版本有哪些方式){.header-anchor} 97 检测浏览器版本有哪些方式？ {#_97-检测浏览器版本有哪些方式}
...
### [\#](#_98-介绍js有哪些内置对象){.header-anchor} 98 介绍JS有哪些内置对象 {#_98-介绍js有哪些内置对象}
...
### [\#](#_99-说几条写javascript的基本规范){.header-anchor} 99 说几条写JavaScript的基本规范 {#_99-说几条写javascript的基本规范}
...
### [\#](#_100-如何编写高性能的javascript){.header-anchor} 100 如何编写高性能的JavaScript {#_100-如何编写高性能的javascript}
...
### [\#](#_101-描述浏览器的渲染过程-dom树和渲染树的区别){.header-anchor} 101 描述浏览器的渲染过程，DOM树和渲染树的区别 {#_101-描述浏览器的渲染过程-dom树和渲染树的区别}
...
### [\#](#_102-script-的位置是否会影响首屏显示时间){.header-anchor} 102 script 的位置是否会影响首屏显示时间 {#_102-script-的位置是否会影响首屏显示时间}
...
### [\#](#_103-介绍-dom-的发展){.header-anchor} 103 介绍 DOM 的发展 {#_103-介绍-dom-的发展}
...
### [\#](#_104-介绍dom0-dom2-dom3事件处理方式区别){.header-anchor} 104 介绍DOM0，DOM2，DOM3事件处理方式区别 {#_104-介绍dom0-dom2-dom3事件处理方式区别}
...
### [\#](#_105-区分什么是-客户区坐标-、-页面坐标-、-屏幕坐标){.header-anchor} 105 区分什么是"客户区坐标"、"页面坐标"、"屏幕坐标" {#_105-区分什么是-客户区坐标-、-页面坐标-、-屏幕坐标}
...
### [\#](#_106-javascript垃圾回收方法){.header-anchor} 106 Javascript垃圾回收方法 {#_106-javascript垃圾回收方法}
...
### [\#](#_107-请解释一下-javascript-的同源策略){.header-anchor} 107 请解释一下 JavaScript 的同源策略 {#_107-请解释一下-javascript-的同源策略}
...
### [\#](#_108-如何删除一个cookie){.header-anchor} 108 如何删除一个cookie {#_108-如何删除一个cookie}
...
### [\#](#_109-页面编码和被请求的资源编码如果不一致如何处理){.header-anchor} 109 页面编码和被请求的资源编码如果不一致如何处理 {#_109-页面编码和被请求的资源编码如果不一致如何处理}
...
### [\#](#_110-把-script-放在-body-之前和之后有什么区别-浏览器会如何解析它们){.header-anchor} 110 把`<script>`放在`</body>`之前和之后有什么区别？浏览器会如何解析它们？ {#_110-把-script-放在-body-之前和之后有什么区别-浏览器会如何解析它们}
...
### [\#](#_111-javascript-中-调用函数有哪几种方式){.header-anchor} 111 JavaScript 中，调用函数有哪几种方式 {#_111-javascript-中-调用函数有哪几种方式}
...
### [\#](#_112-列举一下javascript数组和对象有哪些原生方法){.header-anchor} 112 列举一下JavaScript数组和对象有哪些原生方法？ {#_112-列举一下javascript数组和对象有哪些原生方法}
...
### [\#](#_113-array-slice-与-array-splice-的区别){.header-anchor} 113 Array.slice() 与 Array.splice() 的区别？ {#_113-array-slice-与-array-splice-的区别}
...
### [\#](#_114-mvvm){.header-anchor} 114 MVVM {#_114-mvvm}
...
### [\#](#_115-web应用从服务器主动推送data到客户端有那些方式){.header-anchor} 115 WEB应用从服务器主动推送Data到客户端有那些方式 {#_115-web应用从服务器主动推送data到客户端有那些方式}
...
### [\#](#_116-继承){.header-anchor} 116 继承 {#_116-继承}
...
### [\#](#_117-有四个操作会忽略enumerable为false的属性){.header-anchor} 117 有四个操作会忽略enumerable为false的属性 {#_117-有四个操作会忽略enumerable为false的属性}
...
### [\#](#_118-属性的遍历){.header-anchor} 118 属性的遍历 {#_118-属性的遍历}
...
### [\#](#_119-为什么通常在发送数据埋点请求的时候使用的是-1x1-像素的透明-gif-图片){.header-anchor} 119 为什么通常在发送数据埋点请求的时候使用的是 1x1 像素的透明 gif 图片 {#_119-为什么通常在发送数据埋点请求的时候使用的是-1x1-像素的透明-gif-图片}
...
### [\#](#_120-在输入框中如何判断输入的是一个正确的网址){.header-anchor} 120 在输入框中如何判断输入的是一个正确的网址 {#_120-在输入框中如何判断输入的是一个正确的网址}
...
### [\#](#_122-常用设计模式有哪些并举例使用场景){.header-anchor} 122 常用设计模式有哪些并举例使用场景 {#_122-常用设计模式有哪些并举例使用场景}
...
### [\#](#_122-原型链判断){.header-anchor} 122 原型链判断 {#_122-原型链判断}
...
### [\#](#_123-raf-和-ric-是什么){.header-anchor} 123 RAF 和 RIC 是什么 {#_123-raf-和-ric-是什么}
...
### [\#](#_124-js自定义事件){.header-anchor} 124 js自定义事件 {#_124-js自定义事件}
...
### [\#](#_125-前端性能定位、优化指标以及计算方法){.header-anchor} 125 前端性能定位、优化指标以及计算方法 {#_125-前端性能定位、优化指标以及计算方法}
...
1.  前端性能监控和埋点：通过在关键点上埋点，可以监控网页的加载时间、资源请求、错误等关键性能指标。常用的前端性能监控工具包括自定义的日志记录、第三方服务（如Google
...
### [\#](#_126-谈谈你对函数是一等公民的理解){.header-anchor} 126 谈谈你对函数是一等公民的理解 {#_126-谈谈你对函数是一等公民的理解}
...
## [\#](#四、jquery相关){.header-anchor} 四、jQuery相关 {#四、jquery相关}

### [\#](#_1-你觉得jquery源码有哪些写的好的地方){.header-anchor} 1 你觉得jQuery源码有哪些写的好的地方 {#_1-你觉得jquery源码有哪些写的好的地方}
...
### [\#](#_2-jquery-的实现原理){.header-anchor} 2 jQuery 的实现原理 {#_2-jquery-的实现原理}
...
### [\#](#_3-jquery-fn-的-init-方法返回的-this-指的是什么对象){.header-anchor} 3 `jQuery.fn` 的 `init` 方法返回的 `this` 指的是什么对象 {#_3-jquery-fn-的-init-方法返回的-this-指的是什么对象}
...
### [\#](#_4-jquery-extend-与-jquery-fn-extend-的区别){.header-anchor} 4 jQuery.extend 与 jQuery.fn.extend 的区别 {#_4-jquery-extend-与-jquery-fn-extend-的区别}
...
### [\#](#_5-jquery-的属性拷贝-extend-的实现原理是什么-如何实现深拷贝){.header-anchor} 5 jQuery 的属性拷贝(extend)的实现原理是什么，如何实现深拷贝 {#_5-jquery-的属性拷贝-extend-的实现原理是什么-如何实现深拷贝}
...
### [\#](#_6-jquery-的队列是如何实现的){.header-anchor} 6 jQuery 的队列是如何实现的 {#_6-jquery-的队列是如何实现的}
...
### [\#](#_7-jquery-中的-bind-live-delegate-on-的区别){.header-anchor} 7 jQuery 中的 bind(), live(), delegate(), on()的区别 {#_7-jquery-中的-bind-live-delegate-on-的区别}
...
### [\#](#_8-是否知道自定义事件){.header-anchor} 8 是否知道自定义事件 {#_8-是否知道自定义事件}
...
### [\#](#_9-jquery-通过哪个方法和-sizzle-选择器结合的){.header-anchor} 9 jQuery 通过哪个方法和 Sizzle 选择器结合的 {#_9-jquery-通过哪个方法和-sizzle-选择器结合的}
...
### [\#](#_10-jquery-中如何将数组转化为-json-字符串-然后再转化回来){.header-anchor} 10 jQuery 中如何将数组转化为 JSON 字符串，然后再转化回来 {#_10-jquery-中如何将数组转化为-json-字符串-然后再转化回来}
...
### [\#](#_11-jquery-一个对象可以同时绑定多个事件-这是如何实现的){.header-anchor} 11 jQuery 一个对象可以同时绑定多个事件，这是如何实现的 {#_11-jquery-一个对象可以同时绑定多个事件-这是如何实现的}
...
### [\#](#_12-针对-jquery-的优化方法){.header-anchor} 12 针对 jQuery 的优化方法 {#_12-针对-jquery-的优化方法}
...
### [\#](#_13-jquery-的-slideup-动画-当鼠标快速连续触发-动画会滞后反复执行-该如何处理呢){.header-anchor} 13 jQuery 的 slideUp 动画，当鼠标快速连续触发, 动画会滞后反复执行，该如何处理呢 {#_13-jquery-的-slideup-动画-当鼠标快速连续触发-动画会滞后反复执行-该如何处理呢}
...
### [\#](#_14-jquery-ui-如何自定义组件){.header-anchor} 14 jQuery UI 如何自定义组件 {#_14-jquery-ui-如何自定义组件}
...
### [\#](#_15-jquery-与-jquery-ui、jquery-mobile-区别){.header-anchor} 15 jQuery 与 jQuery UI、jQuery Mobile 区别 {#_15-jquery-与-jquery-ui、jquery-mobile-区别}
...
### [\#](#_16-jquery-和-zepto-的区别-各自的使用场景){.header-anchor} 16 jQuery 和 Zepto 的区别？ 各自的使用场景 {#_16-jquery-和-zepto-的区别-各自的使用场景}
...
### [\#](#_17-jquery对象的特点){.header-anchor} 17 jQuery对象的特点 {#_17-jquery对象的特点}
...
### [\#](#_18-zepto的实现原理){.header-anchor} 18 Zepto的实现原理 {#_18-zepto的实现原理}
...
### [\#](#_19-是否用过-jquery-的-deferred){.header-anchor} 19 是否用过 jQuery 的 Deferred {#_19-是否用过-jquery-的-deferred}

![](https://s.poetries.work/gitee/2020/07/7.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/7.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/8.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/8.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/9.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/9.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/10.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/10.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/11.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/11.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/12.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/12.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/13.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/13.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/14.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/14.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/15.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/15.png" loading="lazy"}
![](https://s.poetries.work/gitee/2020/07/16.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/16.png" loading="lazy"}

## [\#](#五、bootstrap相关){.header-anchor} 五、Bootstrap相关 {#五、bootstrap相关}

### [\#](#_1-什么是bootstrap-以及为什么要使用bootstrap){.header-anchor} 1 什么是Bootstrap？以及为什么要使用Bootstrap？ {#_1-什么是bootstrap-以及为什么要使用bootstrap}
...
### [\#](#_2-使用bootstrap时-要声明的文档类型是什么-以及为什么要这样声明){.header-anchor} 2 使用Bootstrap时，要声明的文档类型是什么？以及为什么要这样声明？ {#_2-使用bootstrap时-要声明的文档类型是什么-以及为什么要这样声明}
...
### [\#](#_3-什么是bootstrap网格系统){.header-anchor} 3 什么是Bootstrap网格系统 {#_3-什么是bootstrap网格系统}
...
### [\#](#_4-bootstrap-网格系统-grid-system-的工作原理){.header-anchor} 4 Bootstrap 网格系统（Grid System）的工作原理 {#_4-bootstrap-网格系统-grid-system-的工作原理}
...
### [\#](#_5-对于各类尺寸的设备-bootstrap设置的class前缀分别是什么){.header-anchor} 5 对于各类尺寸的设备，Bootstrap设置的class前缀分别是什么 {#_5-对于各类尺寸的设备-bootstrap设置的class前缀分别是什么}
...
### [\#](#_6-bootstrap-网格系统列与列之间的间隙宽度是多少){.header-anchor} 6 Bootstrap 网格系统列与列之间的间隙宽度是多少 {#_6-bootstrap-网格系统列与列之间的间隙宽度是多少}

在 Bootstrap 中，默认的列与列之间的间隙宽度是
`30px`。这个间隙宽度是通过列的内边距（`padding`）来实现的，每个列的左右内边距都是
`15px`。这样可以在列与列之间创建一个空白间隔，用于提供视觉上的分隔和排列。

### [\#](#_7-如果需要在一个标题的旁边创建副标题-可以怎样操作){.header-anchor} 7 如果需要在一个标题的旁边创建副标题，可以怎样操作 {#_7-如果需要在一个标题的旁边创建副标题-可以怎样操作}
...
### [\#](#_8-用bootstrap-如何设置文字的对齐方式){.header-anchor} 8 用Bootstrap，如何设置文字的对齐方式？ {#_8-用bootstrap-如何设置文字的对齐方式}
...
### [\#](#_9-bootstrap如何设置响应式表格){.header-anchor} 9 Bootstrap如何设置响应式表格？ {#_9-bootstrap如何设置响应式表格}
...
### [\#](#_10-使用bootstrap创建垂直表单的基本步骤){.header-anchor} 10 使用Bootstrap创建垂直表单的基本步骤？ {#_10-使用bootstrap创建垂直表单的基本步骤}
...
### [\#](#_11-使用bootstrap创建水平表单的基本步骤){.header-anchor} 11 使用Bootstrap创建水平表单的基本步骤？ {#_11-使用bootstrap创建水平表单的基本步骤}
...
### [\#](#_12-使用bootstrap如何创建表单控件的帮助文本){.header-anchor} 12 使用Bootstrap如何创建表单控件的帮助文本？ {#_12-使用bootstrap如何创建表单控件的帮助文本}
...
### [\#](#_13-使用bootstrap激活或禁用按钮要如何操作){.header-anchor} 13 使用Bootstrap激活或禁用按钮要如何操作？ {#_13-使用bootstrap激活或禁用按钮要如何操作}
...
### [\#](#_14-bootstrap有哪些关于img的class){.header-anchor} 14 Bootstrap有哪些关于img的class？ {#_14-bootstrap有哪些关于img的class}
...
### [\#](#_15-bootstrap中有关元素浮动及清除浮动的class){.header-anchor} 15 Bootstrap中有关元素浮动及清除浮动的class？ {#_15-bootstrap中有关元素浮动及清除浮动的class}
...
### [\#](#_16-除了屏幕阅读器外-其他设备上隐藏元素的class){.header-anchor} 16 除了屏幕阅读器外，其他设备上隐藏元素的class？ {#_16-除了屏幕阅读器外-其他设备上隐藏元素的class}
...
### [\#](#_17-bootstrap如何制作下拉菜单){.header-anchor} 17 Bootstrap如何制作下拉菜单？ {#_17-bootstrap如何制作下拉菜单}
...
### [\#](#_18-bootstrap如何制作按钮组-以及水平按钮组和垂直按钮组的优先级){.header-anchor} 18 Bootstrap如何制作按钮组？以及水平按钮组和垂直按钮组的优先级？ {#_18-bootstrap如何制作按钮组-以及水平按钮组和垂直按钮组的优先级}
...
### [\#](#_19-bootstrap如何设置按钮的下拉菜单){.header-anchor} 19 Bootstrap如何设置按钮的下拉菜单？ {#_19-bootstrap如何设置按钮的下拉菜单}
...
### [\#](#_20-bootstrap中的输入框组如何制作){.header-anchor} 20 Bootstrap中的输入框组如何制作？ {#_20-bootstrap中的输入框组如何制作}
...
### [\#](#_21-bootstrap中的导航都有哪些){.header-anchor} 21 Bootstrap中的导航都有哪些？ {#_21-bootstrap中的导航都有哪些}
...
### [\#](#_22-bootstrap中设置分页的class){.header-anchor} 22 Bootstrap中设置分页的class？ {#_22-bootstrap中设置分页的class}
...
### [\#](#_23-bootstrap中显示标签的class){.header-anchor} 23 Bootstrap中显示标签的class？ {#_23-bootstrap中显示标签的class}
...
### [\#](#_24-bootstrap中如何制作徽章){.header-anchor} 24 Bootstrap中如何制作徽章？ {#_24-bootstrap中如何制作徽章}
...
### [\#](#_25-bootstrap中超大屏幕的作用是什么){.header-anchor} 25 Bootstrap中超大屏幕的作用是什么？ {#_25-bootstrap中超大屏幕的作用是什么}
...
## [\#](#六、微信小程序相关){.header-anchor} 六、微信小程序相关 {#六、微信小程序相关}

### [\#](#_1-微信小程序有几个文件){.header-anchor} 1 微信小程序有几个文件 {#_1-微信小程序有几个文件}
...
### [\#](#_2-微信小程序怎样跟事件传值){.header-anchor} 2 微信小程序怎样跟事件传值 {#_2-微信小程序怎样跟事件传值}
...
### [\#](#_3-小程序的-wxss-和-css-有哪些不一样的地方){.header-anchor} 3 小程序的 wxss 和 css 有哪些不一样的地方？ {#_3-小程序的-wxss-和-css-有哪些不一样的地方}
...
### [\#](#_4-小程序关联微信公众号如何确定用户的唯一性){.header-anchor} 4 小程序关联微信公众号如何确定用户的唯一性 {#_4-小程序关联微信公众号如何确定用户的唯一性}
...
### [\#](#_5-微信小程序与vue区别){.header-anchor} 5 微信小程序与vue区别 {#_5-微信小程序与vue区别}
...
## [\#](#七、webpack相关){.header-anchor} 七、webpack相关 {#七、webpack相关}

### [\#](#_1-优化-webpack-打包体积的思路){.header-anchor} 1 优化 webpack 打包体积的思路 {#_1-优化-webpack-打包体积的思路}
...
### [\#](#_2-优化-webpack-打包效率的方法){.header-anchor} 2 优化 webpack 打包效率的方法 {#_2-优化-webpack-打包效率的方法}
...
### [\#](#_3-编写loader){.header-anchor} 3 编写Loader {#_3-编写loader}
...
### [\#](#_4-编写plugin){.header-anchor} 4 编写plugin {#_4-编写plugin}
...
### [\#](#_5-说一下webpack的一些plugin-怎么使用webpack对项目进行优化){.header-anchor} 5 说一下webpack的一些plugin，怎么使用webpack对项目进行优化 {#_5-说一下webpack的一些plugin-怎么使用webpack对项目进行优化}
...
### [\#](#_6-webpack-plugin-和-loader-的区别){.header-anchor} 6 webpack Plugin 和 Loader 的区别 {#_6-webpack-plugin-和-loader-的区别}

-   `Loader` 用于对模块源码进行转换，将非 JavaScript 模块转换为
...
### [\#](#_7-tree-shaking-的原理是什么){.header-anchor} 7 tree shaking 的原理是什么 {#_7-tree-shaking-的原理是什么}
...
### [\#](#_8-common-js-和-es6-中模块引入的区别){.header-anchor} 8 common.js 和 es6 中模块引入的区别 {#_8-common-js-和-es6-中模块引入的区别}
...
### [\#](#_9-babel原理){.header-anchor} 9 babel原理 {#_9-babel原理}
...
> `plugin`用b`abel-traverse`对`AST`树进行遍历转译
...
## [\#](#八、框架相关){.header-anchor} 八、框架相关 {#八、框架相关}
...
### [\#](#_2-vue-nexttick-原理){.header-anchor} 2 Vue nextTick 原理 {#_2-vue-nexttick-原理}
...
### [\#](#_3-vue-diff-原理){.header-anchor} 3 Vue diff 原理 {#_3-vue-diff-原理}
...
### [\#](#_4-路由原理-history-和-hash-两种路由方式的特点){.header-anchor} 4 路由原理 history 和 hash 两种路由方式的特点 {#_4-路由原理-history-和-hash-两种路由方式的特点}
...
## [\#](#九、编程题相关){.header-anchor} 九、编程题相关 {#九、编程题相关}

### [\#](#_1-写一个通用的事件侦听器函数){.header-anchor} 1 写一个通用的事件侦听器函数 {#_1-写一个通用的事件侦听器函数}
...
### [\#](#_2-如何判断一个对象是否为数组){.header-anchor} 2 如何判断一个对象是否为数组 {#_2-如何判断一个对象是否为数组}
...
### [\#](#_3-冒泡排序){.header-anchor} 3 冒泡排序 {#_3-冒泡排序}
...
### [\#](#_4-快速排序){.header-anchor} 4 快速排序 {#_4-快速排序}
...
### [\#](#_5-编写一个方法-求一个字符串的字节长度){.header-anchor} 5 编写一个方法 求一个字符串的字节长度 {#_5-编写一个方法-求一个字符串的字节长度}
...
### [\#](#_6-bind的用法-以及如何实现bind的函数和需要注意的点){.header-anchor} 6 bind的用法，以及如何实现bind的函数和需要注意的点 {#_6-bind的用法-以及如何实现bind的函数和需要注意的点}
...
### [\#](#_7-实现一个函数clone){.header-anchor} 7 实现一个函数clone {#_7-实现一个函数clone}
...
### [\#](#_8-下面这个ul-如何点击每一列的时候alert其index){.header-anchor} 8 下面这个ul，如何点击每一列的时候alert其index {#_8-下面这个ul-如何点击每一列的时候alert其index}
...
### [\#](#_9-定义一个log方法-让它可以代理console-log的方法){.header-anchor} 9 定义一个log方法，让它可以代理console.log的方法 {#_9-定义一个log方法-让它可以代理console-log的方法}
...
### [\#](#_10-输出今天的日期){.header-anchor} 10 输出今天的日期 {#_10-输出今天的日期}
...
### [\#](#_11-用js实现随机选取10-100之间的10个数字-存入一个数组-并排序){.header-anchor} 11 用js实现随机选取10--100之间的10个数字，存入一个数组，并排序 {#_11-用js实现随机选取10-100之间的10个数字-存入一个数组-并排序}
...
### [\#](#_12-写一段js程序提取url中的各个get参数){.header-anchor} 12 写一段JS程序提取URL中的各个GET参数 {#_12-写一段js程序提取url中的各个get参数}
...
### [\#](#_13-写一个function-清除字符串前后的空格){.header-anchor} 13 写一个`function`，清除字符串前后的空格 {#_13-写一个function-清除字符串前后的空格}
...
### [\#](#_14-实现每隔一秒钟输出1-2-3-数字){.header-anchor} 14 实现每隔一秒钟输出1,2,3\...数字 {#_14-实现每隔一秒钟输出1-2-3-数字}
...
### [\#](#_15-实现一个函数-判断输入是不是回文字符串){.header-anchor} 15 实现一个函数，判断输入是不是回文字符串 {#_15-实现一个函数-判断输入是不是回文字符串}
...
### [\#](#_16-数组扁平化处理){.header-anchor} 16 数组扁平化处理 {#_16-数组扁平化处理}
...
### [\#](#_17-实现一个函数clone-可以对javascript中的5种主要的数据类型-包括number、string、object、array、boolean-进行值复制){.header-anchor} 17 实现一个函数clone，可以对JavaScript中的5种主要的数据类型（包括Number、String、Object、Array、Boolean）进行值复制 {#_17-实现一个函数clone-可以对javascript中的5种主要的数据类型-包括number、string、object、array、boolean-进行值复制}
...
### [\#](#_18-手写-promise-all-和-race-京东){.header-anchor} 18 手写 promise.all 和 race（京东） {#_18-手写-promise-all-和-race-京东}
...
### [\#](#_19-手写-实现一个寄生组合继承){.header-anchor} 19 手写-实现一个寄生组合继承 {#_19-手写-实现一个寄生组合继承}
...
### [\#](#_20-手写-new-操作符){.header-anchor} 20 手写-new 操作符 {#_20-手写-new-操作符}
...
### [\#](#_21-手写-settimeout-模拟实现-setinterval-阿里){.header-anchor} 21 手写-setTimeout 模拟实现 setInterval（阿里） {#_21-手写-settimeout-模拟实现-setinterval-阿里}
...
### [\#](#_22-手写-发布订阅模式-字节){.header-anchor} 22 手写-发布订阅模式（字节） {#_22-手写-发布订阅模式-字节}
...
### [\#](#_23-手写-防抖节流-京东){.header-anchor} 23 手写-防抖节流（京东） {#_23-手写-防抖节流-京东}
...
### [\#](#_24-将虚拟-dom-转化为真实-dom-类似的递归题-必考){.header-anchor} 24 将虚拟 Dom 转化为真实 Dom（类似的递归题-必考） {#_24-将虚拟-dom-转化为真实-dom-类似的递归题-必考}
...
### [\#](#_25-手写-实现一个对象的-flatten-方法-阿里){.header-anchor} 25 手写-实现一个对象的 flatten 方法（阿里） {#_25-手写-实现一个对象的-flatten-方法-阿里}
...
### [\#](#_26-手写-判断括号字符串是否有效-小米){.header-anchor} 26 手写-判断括号字符串是否有效（小米） {#_26-手写-判断括号字符串是否有效-小米}
...
### [\#](#_27-手写-查找数组公共前缀-美团){.header-anchor} 27 手写-查找数组公共前缀（美团） {#_27-手写-查找数组公共前缀-美团}
...
### [\#](#_28-手写-字符串最长的不重复子串){.header-anchor} 28 手写-字符串最长的不重复子串 {#_28-手写-字符串最长的不重复子串}
...
## [\#](#十、前端综合问题){.header-anchor} 十、前端综合问题 {#十、前端综合问题}

### [\#](#_1-谈谈你对重构的理解){.header-anchor} 1 谈谈你对重构的理解 {#_1-谈谈你对重构的理解}
...
### [\#](#_2-什么样的前端代码是好的){.header-anchor} 2 什么样的前端代码是好的 {#_2-什么样的前端代码是好的}
...
### [\#](#_3-对前端工程师这个职位是怎么样理解的-它的前景会怎么样){.header-anchor} 3 对前端工程师这个职位是怎么样理解的？它的前景会怎么样 {#_3-对前端工程师这个职位是怎么样理解的-它的前景会怎么样}
...
### [\#](#_4-你觉得前端工程的价值体现在哪){.header-anchor} 4 你觉得前端工程的价值体现在哪 {#_4-你觉得前端工程的价值体现在哪}
...
### [\#](#_5-平时如何管理你的项目){.header-anchor} 5 平时如何管理你的项目 {#_5-平时如何管理你的项目}
...
### [\#](#_6-组件封装){.header-anchor} 6 组件封装 {#_6-组件封装}
...
### [\#](#_7-web-前端开发的注意事项){.header-anchor} 7 Web 前端开发的注意事项 {#_7-web-前端开发的注意事项}
...
### [\#](#_8-在设计-web-app-时-应当遵循以下几点){.header-anchor} 8 在设计 Web APP 时，应当遵循以下几点 {#_8-在设计-web-app-时-应当遵循以下几点}
...
### [\#](#_9-你怎么看待-web-app-hybrid-app-native-app-移动端前端-和-web-前端区别){.header-anchor} 9 你怎么看待 Web App/hybrid App/Native App？（移动端前端 和 Web 前端区别？） {#_9-你怎么看待-web-app-hybrid-app-native-app-移动端前端-和-web-前端区别}
...
## [\#](#十一、hr面相关){.header-anchor} 十一、HR面相关 {#十一、hr面相关}

### [\#](#常见问题){.header-anchor} 常见问题
...
### [\#](#你觉得你有哪些不足之处){.header-anchor} 你觉得你有哪些不足之处
...
### [\#](#你觉得你最大的缺点是什么){.header-anchor} 你觉得你最大的缺点是什么
...
### [\#](#你还有其他公司的offer吗){.header-anchor} 你还有其他公司的Offer吗?
...
### [\#](#为什么从上一家公司离职){.header-anchor} 为什么从上一家公司离职?
...
### [\#](#如何看待加班-996){.header-anchor} 如何看待加班(996)? {#如何看待加班-996}
...
### [\#](#你对未来3-5年的职业规划){.header-anchor} 你对未来3-5年的职业规划
...
### [\#](#如何与hr谈薪资){.header-anchor} 如何与HR谈薪资
