## (#九、编程题相关) 九、编程题相关 {#九、编程题相关}

### (#_1-写一个通用的事件侦听器函数) 1 写一个通用的事件侦听器函数 {#_1-写一个通用的事件侦听器函数}
...
### (#_2-如何判断一个对象是否为数组) 2 如何判断一个对象是否为数组 {#_2-如何判断一个对象是否为数组}
...
### (#_5-编写一个方法-求一个字符串的字节长度) 5 编写一个方法 求一个字符串的字节长度 {#_5-编写一个方法-求一个字符串的字节长度}
...
### (#_6-bind的用法-以及如何实现bind的函数和需要注意的点) 6 bind的用法，以及如何实现bind的函数和需要注意的点 {#_6-bind的用法-以及如何实现bind的函数和需要注意的点}
...
### (#_7-实现一个函数clone) 7 实现一个函数clone {#_7-实现一个函数clone}
...
### (#_8-下面这个ul-如何点击每一列的时候alert其index) 8 下面这个ul，如何点击每一列的时候alert其index {#_8-下面这个ul-如何点击每一列的时候alert其index}
...
### (#_9-定义一个log方法-让它可以代理console-log的方法) 9 定义一个log方法，让它可以代理console.log的方法 {#_9-定义一个log方法-让它可以代理console-log的方法}
...
### (#_10-输出今天的日期) 10 输出今天的日期 {#_10-输出今天的日期}
...
### (#_11-用js实现随机选取10-100之间的10个数字-存入一个数组-并排序) 11 用js实现随机选取10--100之间的10个数字，存入一个数组，并排序 {#_11-用js实现随机选取10-100之间的10个数字-存入一个数组-并排序}
...
### (#_12-写一段js程序提取url中的各个get参数) 12 写一段JS程序提取URL中的各个GET参数 {#_12-写一段js程序提取url中的各个get参数}
...
### (#_13-写一个function-清除字符串前后的空格) 13 写一个`function`，清除字符串前后的空格 {#_13-写一个function-清除字符串前后的空格}
...
### (#_14-实现每隔一秒钟输出1-2-3-数字) 14 实现每隔一秒钟输出1,2,3\...数字 {#_14-实现每隔一秒钟输出1-2-3-数字}
...
### (#_15-实现一个函数-判断输入是不是回文字符串) 15 实现一个函数，判断输入是不是回文字符串 {#_15-实现一个函数-判断输入是不是回文字符串}
...
### (#_16-数组扁平化处理) 16 数组扁平化处理 {#_16-数组扁平化处理}
...
### (#_17-实现一个函数clone-可以对javascript中的5种主要的数据类型-包括number、string、object、array、boolean-进行值复制) 17 实现一个函数clone，可以对JavaScript中的5种主要的数据类型（包括Number、String、Object、Array、Boolean）进行值复制 {#_17-实现一个函数clone-可以对javascript中的5种主要的数据类型-包括number、string、object、array、boolean-进行值复制}
...
### (#_18-手写-promise-all-和-race-京东) 18 手写 promise.all 和 race（京东） {#_18-手写-promise-all-和-race-京东}
...
### (#_19-手写-实现一个寄生组合继承) 19 手写-实现一个寄生组合继承 {#_19-手写-实现一个寄生组合继承}
...
### (#_20-手写-new-操作符) 20 手写-new 操作符 {#_20-手写-new-操作符}
...
### (#_21-手写-settimeout-模拟实现-setinterval-阿里) 21 手写-setTimeout 模拟实现 setInterval（阿里） {#_21-手写-settimeout-模拟实现-setinterval-阿里}
...
### (#_22-手写-发布订阅模式-字节) 22 手写-发布订阅模式（字节） {#_22-手写-发布订阅模式-字节}
...
### (#_23-手写-防抖节流-京东) 23 手写-防抖节流（京东） {#_23-手写-防抖节流-京东}
...
### (#_24-将虚拟-dom-转化为真实-dom-类似的递归题-必考) 24 将虚拟 Dom 转化为真实 Dom（类似的递归题-必考） {#_24-将虚拟-dom-转化为真实-dom-类似的递归题-必考}
...
### (#_25-手写-实现一个对象的-flatten-方法-阿里) 25 手写-实现一个对象的 flatten 方法（阿里） {#_25-手写-实现一个对象的-flatten-方法-阿里}
...
### (#_26-手写-判断括号字符串是否有效-小米) 26 手写-判断括号字符串是否有效（小米） {#_26-手写-判断括号字符串是否有效-小米}
...
### (#_27-手写-查找数组公共前缀-美团) 27 手写-查找数组公共前缀（美团） {#_27-手写-查找数组公共前缀-美团}
...
### (#_28-手写-字符串最长的不重复子串) 28 手写-字符串最长的不重复子串 {#_28-手写-字符串最长的不重复子串}
