...
![](https://s.poetries.work/images/20210415090353.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210415090353.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210415092040.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210415092040.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210415092356.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210415092356.png"
loading="lazy"}
...
个浏览器（Browser）主进程、1 个 GPU 进程、1
个网络（NetWork）进程、多个渲染进程和多个插件进程。
...
![img](https://s.poetries.work/gitee/2019/10/19.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2019/10/19.png" loading="lazy"}

![img](https://s.poetries.work/gitee/2019/10/20.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2019/10/20.png" loading="lazy"}
...
![img](https://s.poetries.work/gitee/2019/10/21.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2019/10/21.png" loading="lazy"}
...
![img](https://s.poetries.work/gitee/2019/10/22.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2019/10/22.png" loading="lazy"}

![img](https://s.poetries.work/gitee/2019/10/23.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2019/10/23.png" loading="lazy"}
...
但在 HTML5
规范中，并不支持这种方式，所以`尽量不要使用 meta 标签来设置缓存`。
...
-   先根据这个资源的一些 http header
    判断它是否命中强缓存，先检查`Cache-Control`，如果命中，则直接从本地获取缓存资源，不会发请求到服务器；
...
![](https://s.poetries.work/images/20210421172522.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210421172522.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210415090547.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210415090547.png"
loading="lazy"}
...
![image.png](https://s.poetries.work/gitee/2020/07/4.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/4.png" loading="lazy"}
...
![](https://s.poetries.work/gitee/2020/07/fe/19.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/fe/19.png"
loading="lazy"}
...
> .outbound} [(opens new
> window)]{.sr-only}](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy){target="_blank"
...
![](https://s.poetries.work/gitee/2020/07/fe/20.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/07/fe/20.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210506174602.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210506174602.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210506174856.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210506174856.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210506175834.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210506175834.png"
loading="lazy"}
...
![](https://s.poetries.work/gitee/2020/09/96.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/09/96.png" loading="lazy"}

> 在 Cache 中也可以发现我们所需的文件已被缓存

![](https://s.poetries.work/gitee/2020/09/97.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/gitee/2020/09/97.png" loading="lazy"}
...
![](https://s.poetries.work/images/20210420215756.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210420215756.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504134355.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504134355.png"
loading="lazy"}

**1. DNS域名解析**

![](https://s.poetries.work/images/20210504134816.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504134816.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504134850.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504134850.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504134913.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504134913.png"
loading="lazy"}

结合起来的过程，可以用一个图表示：

![](https://s.poetries.work/images/20210504134925.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504134925.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504135417.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504135417.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504135549.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504135549.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504135701.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504135701.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504135900.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504135900.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504140042.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504140042.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504201448.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504201448.png"
loading="lazy"}
...
![](https://s.poetries.work/images/20210504201623.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504201623.png"
loading="lazy"}
...
> `callee` 是 `arguments`
> 对象的一个属性。它可以用于引用该函数的函数体内当前正在执行的函数。在严格模式下，第5版
> ECMAScript (ES5)
> 禁止使用`arguments.callee()`。当一个函数必须调用自身的时候, 避免使用
> `arguments.callee()`,
...
![](https://s.poetries.work/images/20210504202154.png){.lazy
.medium-zoom-image
data-src="https://s.poetries.work/images/20210504202154.png"
loading="lazy"}
